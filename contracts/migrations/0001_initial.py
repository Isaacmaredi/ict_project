    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_id', models.PositiveIntegerField(verbose_name='Contract ID')),
                ('description', models.CharField(max_length=300)),
                ('responsible_unit', models.CharField(max_length=300, verbose_name='Rsponsible Unit')),
                ...
                ('status', models.CharField(choices=[('Active', 'Active'), ('Alert 1', 'Alert 1'), ('Alert 2', 'Alert 2'), ('Expired', 'Expired')], default='Active', max_length=300)),
                ...
                ('owner', models.ForeignKey(max_length=300, on_delete=django.db.models.deletion.DO_NOTHING, to='profiles.profile', verbose_name='Responsible Manager')),
                ('supplier', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vendors', to='vendors.vendor')),
            ],
            options={
                'ordering': ('-uploaded',),
            },
