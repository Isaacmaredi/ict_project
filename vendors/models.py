...
class Vendor(models.Model):  
    ...
    physical_address = models.CharField(max_length=300, verbose_name="Physical Address")
    postal_address = models.CharField(max_length=300, verbose_name="Postal Address")
    ...
    def get_absolute_url(self):
        return reverse ('vendors:vendor-admin')
